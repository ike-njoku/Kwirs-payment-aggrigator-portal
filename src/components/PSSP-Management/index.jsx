...
const handleCreateResourceModal = async (newResourceURL) => {
  ...
  const newResourceData = {
    ...
    Dsecription: newResourceURL.Description, // ✅ Ensure spelling is correct
  };
  ...
  try {
    ...
    const createdDataRepresentation = {
      ...
      // Username: authenticatedUser?.email || "Unknown",
      // dateCreated: new Date().toISOString().split("T")[0],
      // ResourceId: createResourceResponse.Data?.ResourceId || "Unknown", // ✅ Fixed typo (was 'ResourseId')
    };
